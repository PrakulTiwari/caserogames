...
const hamburger = document.querySelector('.about-page nav .hamburger');
const navbar = document.querySelector('.about-page nav ul');
const cross = document.querySelector('.about-page nav ul .cross');
